function [ varargout ] = rca2mfscm_plain( mfscm, distanceBoundOnEdges, birthDeathGivers, extraInputParams )

% rca1mfscm(mfscm, distanceBoundOnEdges) This code computes the 2- and 0-D 
...
%
% If only one object is captured in output, it is the 2-D diagram.  
%
...
tda.RCA2( { 'taskChoice=M23', 'supplyDataAs=monotonicFunctionOnSimplicialComplexMatrix', param2 }, mfscm );  % compute 2-D persistence, using supplied parameters
...
if birthDeathGivers
	...
	I1 = tda.getResults(1).getIntervalsAndBirthDeathGiversDim1;  % 2-D intervals with extra info
else 
	I0 = tda.getResults(0).getIntervals;  % 0-D intervals
	I1 = tda.getResults(1).getIntervals;  % 2-D intervals
end
