function [ varargout ] = testSuite_rca0()
...
%
% Run Tests test_rca0pc
%

% Subset of tests in 'test_rca0pc_1'

[ testName, testsPassed, testsRun ] = test_rca0pc_1();
...
%
% Run Tests test_rca0pc (just as placeholder)
%


% Subset of tests in 'test_rca0pc_2'

[ testName, testsPassed, testsRun ] = test_rca0pc_2();
totalTestsPassed = totalTestsPassed + testsPassed;
totalTestsRun = totalTestsRun + testsRun;
disp( [ '*** Test ' testName ': ' num2str( testsPassed ) ' of ' num2str( testsRun ) ' tests passed.' ] );
